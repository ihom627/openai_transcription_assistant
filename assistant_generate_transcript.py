...
#IHOM, separate part1 to only transcribe the audio file to text file ./transcript.txt
...
if __name__ == '__main__':
    ...
    #ihom, change to command line arg
    ...
    t0 = time.time()
    #ihom, pass in file as command line arg
    #segments = split_mp3('Data/' + file_prefix +'.mp3')  # Split mp3 into segments small enough to transcribe
    segments = split_mp3(input_file)  # Split mp3 into segments small enough to transcribe
    t1 = time.time()
    ...
    with open(r'Data/' + input_file + '_transcript_' + today + '.txt',
